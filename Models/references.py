...
def other_links():
    ...
    link6 = '[Time Series Forecasting With Prophet in Python](https://machinelearningmastery.com/time-series-forecasting-with-prophet-in-python/)'
    link7 = '[Build Your First Data Visualization Web App in Python Using Streamlit](https://towardsdatascience.com/build-your-first-data-visualization-web-app-in-python-using-streamlit-37e4c83a85db)'
    link8 = '[What is time series forecasting?](https://www.influxdata.com/time-series-forecasting-methods/)'
